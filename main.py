...
def deterministic_policy(event: Dict[str, Any]) -> Tuple[str, str]:
    """
    Deterministic first-pass control logic.
...
def build_reasoning_prompt(event: Dict[str, Any], deterministic_decision: str, deterministic_reason: str) -> str:
    return f"""
...
def vertex_reasoning(event: Dict[str, Any], deterministic_decision: str, deterministic_reason: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Fallback if the model returns wrapped or imperfect JSON
        return {
...
def normalize_event(payload: Dict[str, Any]) -> Dict[str, Any]:
    """
    Accepts either:
    - direct local event JSON
    - wrapped audit-log style payload
    """
